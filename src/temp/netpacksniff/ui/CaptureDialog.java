 ...
 * Author: Aditya
 * 
 * This class displays a dialog window for selecting network interface devices and capture options.
 * It uses JpcapCaptor to manage device selection, promiscuous mode, and capture settings.
 */
...
public class CaptureDialog extends JDialog implements ActionListener {
    ...
    public CaptureDialog(JFrame parent) {
        ...
        if (devices == null) {
            JOptionPane.showMessageDialog(parent, "No devices found.");
            dispose();
            return;
        } else {
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (cmd.equals("Whole")) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Please input a valid integer for capture length.");
